...
class SmtpServer(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Smtp Server'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype SmtpServer
        """
        result = SmtpServer(name=context.resource.name)
    ...
    def smtp_port(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SMTP Port'] if 'Smtp Server.SMTP Port' in self.attributes else None

    @smtp_port.setter
    def smtp_port(self, value='587'):
        """
        Port of smtp server (587, 25, 465)
        :type value: str
        """
        self.attributes['Smtp Server.SMTP Port'] = value
    ...
    def smtp_auth_enabled(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.SMTP Auth Enabled'] if 'Smtp Server.SMTP Auth Enabled' in self.attributes else None

    @smtp_auth_enabled.setter
    def smtp_auth_enabled(self, value=True):
        """
        
        :type value: bool
        """
        self.attributes['Smtp Server.SMTP Auth Enabled'] = value
    ...
    def ssl_enabled(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.SSL Enabled'] if 'Smtp Server.SSL Enabled' in self.attributes else None

    @ssl_enabled.setter
    def ssl_enabled(self, value=True):
        """
        
        :type value: bool
        """
        self.attributes['Smtp Server.SSL Enabled'] = value
    ...
    def proxy_enabled(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.Proxy Enabled'] if 'Smtp Server.Proxy Enabled' in self.attributes else None

    @proxy_enabled.setter
    def proxy_enabled(self, value=False):
        """
        Boolean to determine SMTP flow if server is behind http proxy
        :type value: bool
        """
        self.attributes['Smtp Server.Proxy Enabled'] = value
    ...
    def proxy_host(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Proxy Host'] if 'Smtp Server.Proxy Host' in self.attributes else None

    @proxy_host.setter
    def proxy_host(self, value):
        """
        IP of http proxy server
        :type value: str
        """
        self.attributes['Smtp Server.Proxy Host'] = value
    ...
    def proxy_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Smtp Server.Proxy Port'] if 'Smtp Server.Proxy Port' in self.attributes else None

    @proxy_port.setter
    def proxy_port(self, value='8888'):
        """
        port of proxy server
        :type value: float
        """
        self.attributes['Smtp Server.Proxy Port'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.User'] if 'Smtp Server.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.Password'] if 'Smtp Server.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.Enable Password'] if 'Smtp Server.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.Power Management'] if 'Smtp Server.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Smtp Server.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['Smtp Server.Sessions Concurrency Limit'] if 'Smtp Server.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['Smtp Server.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.SNMP Read Community'] if 'Smtp Server.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.SNMP Write Community'] if 'Smtp Server.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SNMP V3 User'] if 'Smtp Server.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.SNMP V3 Password'] if 'Smtp Server.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SNMP V3 Private Key'] if 'Smtp Server.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.SNMP V3 Private Key'] = value
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SNMP V3 Authentication Protocol'] if 'Smtp Server.SNMP V3 Authentication Protocol' in self.attributes else None
    ...
    def snmp_v3_authentication_protocol(self, value='No Authentication Protocol'):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.SNMP V3 Authentication Protocol'] = value
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SNMP V3 Privacy Protocol'] if 'Smtp Server.SNMP V3 Privacy Protocol' in self.attributes else None
    ...
    def snmp_v3_privacy_protocol(self, value='No Privacy Protocol'):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.SNMP V3 Privacy Protocol'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.SNMP Version'] if 'Smtp Server.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.Enable SNMP'] if 'Smtp Server.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Smtp Server.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Smtp Server.Disable SNMP'] if 'Smtp Server.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['Smtp Server.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Console Server IP Address'] if 'Smtp Server.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Console User'] if 'Smtp Server.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Smtp Server.Console Port'] if 'Smtp Server.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Smtp Server.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.Console Password'] if 'Smtp Server.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.CLI Connection Type'] if 'Smtp Server.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Smtp Server.CLI TCP Port'] if 'Smtp Server.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Smtp Server.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Backup Location'] if 'Smtp Server.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Backup Type'] if 'Smtp Server.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.Backup User'] if 'Smtp Server.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Smtp Server.Backup Password'] if 'Smtp Server.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Smtp Server.Backup Password'] = value
...
class ResourcePort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Smtp Server.ResourcePort'
        self._name = name
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.ResourcePort.MAC Address'] if 'Smtp Server.ResourcePort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.ResourcePort.MAC Address'] = value
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.ResourcePort.IPv4 Address'] if 'Smtp Server.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv4_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.ResourcePort.IPv4 Address'] = value
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.ResourcePort.IPv6 Address'] if 'Smtp Server.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def ipv6_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.ResourcePort.IPv6 Address'] = value
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.ResourcePort.Port Speed'] if 'Smtp Server.ResourcePort.Port Speed' in self.attributes else None
    ...
    def port_speed(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.ResourcePort.Port Speed'] = value
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Smtp Server.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.GenericPowerPort.Model'] if 'Smtp Server.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.GenericPowerPort.Serial Number'] if 'Smtp Server.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.GenericPowerPort.Version'] if 'Smtp Server.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Smtp Server.GenericPowerPort.Port Description'] if 'Smtp Server.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['Smtp Server.GenericPowerPort.Port Description'] = value
